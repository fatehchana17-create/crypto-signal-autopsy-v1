...
REASON_LABELS = {
    ...
    "early_extreme_overextension": "Early extreme overextension",
    "too_early_after_large_pump": "Too early after a large pump",
    "hot_launch_buy_pressure_below_45_percent": "Hot launch buy pressure below 45%",
    "dangerous_low_buy_pressure": "Dangerously low buy pressure",
    "hot_momentum_weak_buy_pressure": "Hot momentum with weak buy pressure",
    "hot_momentum_low_unique_buyers": "Hot momentum with too few unique buyers",
    "hot_volume_liquidity_rotation_risk": "Hot volume/liquidity rotation risk",
    "weak_overextended_pump": "Weak overextended pump",
    "failed_delayed_entry_return": "Failed paper survival return check",
    "failed_delayed_entry_bearish_volume_expansion": "Failed paper survival: bearish volume expansion",
